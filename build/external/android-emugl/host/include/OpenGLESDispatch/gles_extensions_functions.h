// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs external/android-emugl/host/libs/libOpenGLESDispatch/gles_extensions.entries --output=/openvmi/build/external/android-emugl/host/include/OpenGLESDispatch/gles_extensions_functions.h
