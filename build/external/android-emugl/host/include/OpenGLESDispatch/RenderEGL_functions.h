// Auto-generated with: android/scripts/gen-entries.py --mode=functions external/android-emugl/host/libs/libOpenGLESDispatch/render_egl.entries --output=/openvmi/build/external/android-emugl/host/include/OpenGLESDispatch/RenderEGL_functions.h
