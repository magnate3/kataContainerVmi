// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs external/android-emugl/host/libs/libOpenGLESDispatch/gles_common.entries --output=/openvmi/build/external/android-emugl/host/include/OpenGLESDispatch/gles_common_functions.h
