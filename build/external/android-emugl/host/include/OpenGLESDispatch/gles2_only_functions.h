// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs external/android-emugl/host/libs/libOpenGLESDispatch/gles2_only.entries --output=/openvmi/build/external/android-emugl/host/include/OpenGLESDispatch/gles2_only_functions.h
