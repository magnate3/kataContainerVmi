// Auto-generated with: android/scripts/gen-entries.py --mode=funcargs external/android-emugl/host/libs/libOpenGLESDispatch/gles1_only.entries --output=/openvmi/build/external/android-emugl/host/include/OpenGLESDispatch/gles1_only_functions.h
